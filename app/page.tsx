...
import { OpenAIConfig, defaultConfig } from './types/types';
      ...
      <nav className="flex justify-between items-center p-4">
        ...
        <div className="flex items-center gap-4">
          <h1 className="text-xl font-semibold">
            Talk to <span className="highlighted-text">Code-Upya</span>
          </h1>
          <button
            onClick={() => setIsSettingsOpen(true)}
            className="p-2 rounded-full hover:bg-[#0a1825] transition-colors"
